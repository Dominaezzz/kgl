...
actual enum class Access(override val value: VkAccessFlagBits) : VkFlag<Access> {
	...
	companion object {
		private val enumLookUpMap: Map<UInt, Access> = enumValues<Access>().associateBy({
			it.value
		})

		fun fromMultiple(value: VkAccessFlagBits): VkFlag<Access> = VkFlag(value)

		fun from(value: VkAccessFlagBits): Access = enumLookUpMap[value]!!
	}
}
