...
actual enum class BorderColor(override val value: VkBorderColor) : VkEnum<BorderColor> {
	...
	companion object {
		fun from(value: VkBorderColor): BorderColor = enumValues<BorderColor>()[value.toInt()]
	}
}
