...
actual enum class Format(override val value: VkFormat) : VkEnum<Format> {
	...
	companion object {
		private val enumLookUpMap: Map<UInt, Format> = enumValues<Format>().associateBy({
			it.value
		})

		fun from(value: VkFormat): Format = enumLookUpMap[value]!!
	}
}
