...
actual enum class ImageViewType(override val value: VkImageViewType) : VkEnum<ImageViewType> {
	...
	companion object {
		fun from(value: VkImageViewType): ImageViewType = enumValues<ImageViewType>()[value.toInt()]
	}
}
