...
import cvulkan.VkAcquireNextImageInfoKHR
import cvulkan.VkSwapchainCreateInfoKHR
...
actual class SwapchainCreateInfoKHRBuilder(internal val target: VkSwapchainCreateInfoKHR) {
	...
	internal fun init(
		...
		target.sType = cvulkan.VK_STRUCTURE_TYPE_SWAPCHAIN_CREATE_INFO_KHR
		target.pNext = null
		target.surface = surface.toVkType()
		target.pQueueFamilyIndices = queueFamilyIndices?.toVkType()
		target.queueFamilyIndexCount = queueFamilyIndices?.size?.toUInt() ?: 0U
