...
expect class ObjectTableEntryNVXBuilder {
	var type: ObjectEntryTypeNVX?

	var flags: VkFlag<ObjectEntryUsageNVX>?
}

expect class RegisterObjectsNVXBuilder {
	fun entry(block: ObjectTableEntryNVXBuilder.() -> Unit = {})
}
